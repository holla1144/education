module Map
  ...
  CENTRAL_CORRIDOR = Room.new("Central Corridor", 
    ...
    you entire crew. You are the last surviving member and your last
  ...
  LASER_WEAPON_ARMORY = Room.new("Laster Weapon Armory",
    """
    Lucky for you they made you learn Gothon insults in the academy.
    You tell the one Gothon joke you know:
    KJ;kjalsdkjfn cihjoiu, askdfjsadkjf;k, ;kj;lkjlkjkjiiieke, 
  ...
  THE_BRIDGE = Room.new("The Bridge",
    ...
    You burst onto the Bridge with the nutron destruct bomb under
    ...
    They haven't pulled their weapons out yet, as they see the active bomb under
  ...
  ESCAPE_POD = Room.new("Escape Pod",
    ...
    like hardly any Gothons are on the ship, so your run is clear of interference.
    You get tot he chamber with the escape pods, and 
  ...
  THE_END_WINNER = Room.new("The End",
    ...
    look back and see your ship impolode and then explode
    like a bright star, taking out the Gothon ship at the 
    same time. You won!
    """
  )
  ...
  THE_END_LOSER = Room.new("The End",
    ...
    The pod escaped out into the void of space, 
    then impoloed as the hull ruptures, crushing your body
    into jam jelly
    """
  )
  ...
  # Update rooms with path hash
  ESCAPE_POD.add_paths({
    '2' => THE_END_WINNER,
    '*' => THE_END_LOSER   # Gets returned if any other hash key is provided besides 2
  })
  ...
  def Map::save_room(session, room)
    # Store room in session using its name
