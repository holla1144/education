...
;; Functions can produce other functions, and take other functions as argument
...
;; String LoS -> Bool
;; produce true if los includes string

;; Refactoring our check-expects for contains? 
(check-expect (contains? "UBC" empty) false)
(check-expect (contains? "UBC" (cons "McGill" empty)) false)
(check-expect (contains? "UBC" (cons "UBC" empty)) true)
...
;; Given a predicate and list (n0, n1 ...) produces a list of values
