...
;; The first element in the signature is shorthand for a function
;; X is meant to stand for a type paramater. We are saying that the function
;; consumes X, which means the second element must be a list of X

;; The signature is saying:
;; give map2 a function that takes an X and produces a Y.
;; map2 creates a list of the return value of the function,
;; which is a list of Y
...
(check-expect (map2 string-length (list "four" "three" "two" "one"))(list 4 5 3 3))          
...
;; Pred is a "one argument function"
